...
- [WCAG-EM 2.0](https://www.w3.org/TR/wcag-em-2/) ist eine informative W3C Group Note für die strukturierte Evaluation digitaler Produkte. Sie beschreibt Scope, Produkterkundung, repräsentative Auswahl, Evaluation und Berichterstattung, ergänzt oder verändert aber keine WCAG-Anforderung.
- [Inclusive Components](https://inclusive-components.design/) erläutert komponentenbezogene Entscheidungen zu Semantik, Interaktion, progressiver Verbesserung und fehlertoleranter Gestaltung. Die Beispiele sind eine ergänzende Design- und Patternreferenz, keine aktuelle Norm, keine vollständige Prüfmethode und nicht ungeprüft als Produktionscode zu übernehmen.
