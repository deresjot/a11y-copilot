...
Eine Antwort soll normative Aussagen auf eine konkrete Quelle zurückführen. Maßgeblich sind insbesondere [WCAG 2.2](https://www.w3.org/TR/WCAG22/), der [HTML Standard](https://html.spec.whatwg.org/), [WAI-ARIA](https://www.w3.org/TR/wai-aria-1.2/) und [ARIA in HTML](https://www.w3.org/TR/html-aria/). Für umfassende Evaluationen dient [WCAG-EM 2.0](https://www.w3.org/TR/wcag-em-2/) als informative methodische Grundlage. Der [ARIA Authoring Practices Guide](https://www.w3.org/WAI/ARIA/apg/) und [Inclusive Components](https://inclusive-components.design/) sind informative Pattern- und Designreferenzen, keine zusätzlichen WCAG-Anforderungen und kein Ersatz für Tests im konkreten Produkt. Weitere Einordnung steht in [Standards und Primärquellen](references/standards.md).
